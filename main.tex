...
oneside, % Two side (alternating margins) for binding by default, uncomment to switch to one side %(tree killer option)
english, % ngerman for German
onespacing, % Single line spacing, alternatives: onehalfspacing or doublespacing
...
This report aims to explain how to build a sensor platform that can transmit data across the internet securely and shows that security on low powered microcontrollers is possible and easy. It introduces a light weight cryptographic library and demonstrates it's effectiveness on a low powered system and provides considerations on the level of security it provides.
...
%\include{Chapters/ProjectToolsandPlanning}
\include{Chapters/Background} 
\include{Chapters/Design}
\include{Chapters/Implementation} 
\include{Chapters/StrengthOfSecurity}
\include{Chapters/Results}
\include{Chapters/CriticalEvaluation}
