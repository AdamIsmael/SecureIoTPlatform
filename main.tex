...
\lstdefinestyle{Arduino}{%
    ...
    keywords={println, print, for, OneWire,select,write,delay, reset, byte, char, const, long, unsigned, stop},%                 define keywords
...
\lstdefinestyle{Java}{
  %style=FormattedNumber,
    keywords={request, response,printWriter },%                 define keywords
    morecomment=[l]{//},%             treat // as comments
    morecomment=[s]{/*}{*/},%         define /* ... */ comments
    emph={protected, void, throws},%        keywords to emphasize
